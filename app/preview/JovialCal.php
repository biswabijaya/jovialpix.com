    ...
    <div id="wbweb-app" style="margin: 22px;">
        <div class="container card">
            <div class="row justify-column-center">
                ...
                while($res = mysqli_fetch_array($result)){ $counterr=$counter-1;
                  echo '
                  <div class="col-6 col-sm-4 col-md-3 col-lg-2" style="padding: 15px;">
                    <div class="row shadow " style="margin: auto;">
                      <div class="col-12" style="padding: 0;">
                        <a data-fancybox="gallery" href="../gallery/files/'.$res['file_name'].'" data-caption="Image - '.date("M", strtotime("January +$counterr months")).' - '.$_SESSION['templateyear'].'"><img src="../gallery/thumbs/'.$res['file_name'].'" class="img-fluid responsive"> </a>
                      </div>
                      <div class="col-12" style="padding: 0;">
                        <a data-fancybox="calender" href="../gallery/calender/'.$counter.'.jpg" data-caption="'.date("M", strtotime("January +$counterr months")).' - '.$_SESSION['templateyear'].'"><img src="../gallery/calenderthumbs/'.$counter.'.jpg" class="img-fluid responsive"> </a>
                      </div>
                    </div>
                    <p>'.date("M", strtotime("January +$counterr months")).' - '.$_SESSION['templateyear'].'</p>
                  </div>
                  ';
                  $counter++;
                }
