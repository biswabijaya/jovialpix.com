...
include 'components/scripts/orders.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <?php
       include 'components/sections/orders.php';
    ?>
    </div>
    <!-- /.container-fluid-->
    ...
    <?php include 'components/modals/orders.php'; ?>
    <?php include 'components/includes/js.php';?>
    <?php include 'components/scripts/ordersjs.php';?>
  </div>
</body>
