...
<html>
    <head>
		...
		<script src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/account/assets/imageuploader/jquery.min.js"></script>
		<script src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/account/assets/imageuploader/bootstrap.min.js"></script>
		<script src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/account/assets/imageuploader/croppie.js"></script>
		<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/account/assets/imageuploader/bootstrap.min.css" />
		<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/account/assets/imageuploader/croppie.css" />
    </head>
    <body>
        <div class="container">
          <br />
